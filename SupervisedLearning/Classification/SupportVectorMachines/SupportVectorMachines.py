# we use the same wine dataset, but this time we are gonna get our hands dirty 
# we are gonna try hyperparameter tuning  this time 
# also we will try some new things for error handlings and stuffs
